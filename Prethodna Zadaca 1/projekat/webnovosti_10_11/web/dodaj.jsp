...
<%-- 
    Document   : dodaj
    Created on : Nov 15, 2020, 11:41:14 AM
    Author     : User
--%>
...
<html>
    ...
    <body>
        <div class="cijela">
            <h1 class="display-4">Dobavanje novog korisnika</h1>
            <div class="form-row justify-content-center">
                <form action="dodajKorisnika" method="POST">
                    ...
                    <div class="p-2 d-flex justify-content-between"><label>Telefon: </label><input type="text" name="telefon"></div>
                    <div class="p-2 d-flex justify-content-between">
                        Rola:
                        <select name="rola" class="w-50"  >
